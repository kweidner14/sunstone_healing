...
router.post('/', isLoggedIn, upload.array('images', 2), asyncErrorHandler(postCreate));
...
router.put('/:id', upload.array('images', 2), isLoggedIn, asyncErrorHandler(isAuthor), asyncErrorHandler(postUpdate));
